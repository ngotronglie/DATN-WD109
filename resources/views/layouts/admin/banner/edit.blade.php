    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title mb-4">Chỉnh Sửa Banner</h5>
                        ...
                        <form action="{{ route('admin.banners.update', $banner) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                @if($banner->img)
                                    <div class="mb-2">
                                        <img src="{{ asset('images/banners/' . $banner->img) }}" alt="{{ $banner->title }}" style="max-width: 200px;">
                                    </div>
                                @endif
                                <input type="file" class="form-control" id="img" name="img" accept="image/*">
                                <small class="text-muted">Để trống nếu không muốn thay đổi hình ảnh. Định dạng: JPEG, PNG, JPG, GIF. Kích thước tối đa: 2MB</small>
                            </div>
