    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Quản lý dung lượng</h4>
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                        <li class="breadcrumb-item active">Dung lượng</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('admin.capacities.create') }}" class="btn btn-success create-btn">
                        <i class="ri-add-line align-bottom me-1"></i> Thêm dung lượng mới
                    </a>
                </div>
                ...
                <div class="card-body pt-0">
                        ...
                        <table class="table table-bordered dt-responsive nowrap table-striped align-middle" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th scope="row">
                                        <div class="form-check">
                                            <input class="form-check-input fs-15" type="checkbox" name="checkAll" value="{{ $capacity->id }}">
                                        </div>
                                    </th>
                                    <td>{{ $capacity->id }}</td>
                                    <td>{{ $capacity->name }}</td>
                                    ...
                                    <td>
                                        <div class="d-flex gap-2">
                                            <a href="{{ route('admin.capacities.edit', $capacity) }}" class="btn btn-sm btn-info edit-item-btn">
                                                <i class="ri-pencil-fill align-bottom"></i> Sửa
                                            </a>
                                            
                                            <form action="{{ route('admin.capacities.destroy', $capacity) }}" method="POST" class="d-inline delete-form">
                                                @csrf
                                                @method('DELETE')
                    ...
                    <div class="d-flex justify-content-end mt-3">
                        {{ $capacities->links('pagination::bootstrap-4') }}
                    </div>
                </div>
            </div>
        </div>
