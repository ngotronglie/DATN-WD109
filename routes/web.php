...
Route::middleware(['auth', 'is_admin'])->prefix('admin')->name('admin.')->group(function () {
    ...
    // Flash Sale Items
    Route::resource('flash-sale-items', \App\Http\Controllers\Admin\FlashSaleItemController::class);
});
...
Route::post('/blogs/{blog}/comments', [\App\Http\Controllers\CommentController::class, 'store'])->name('comments.store');
   ...
   Route::get('/account', [\App\Http\Controllers\Client\UserController::class, 'index'])->name('account');
