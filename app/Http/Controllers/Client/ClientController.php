...
class ClientController extends Controller
{
    ...
    public function products(Request $request)
    {
        ...
        // Lọc theo giá (nếu giá ở bảng variants, dùng whereHas)
        ...
        // Lọc theo màu sắc (nếu màu ở bảng variants)
        ...
        $products = $query->with(['variants' => function($q) {
            $q->where('quantity', '>', 0)->orderBy('id');
        }])->paginate(12);

        return view('layouts.user.shop', compact('products', 'categories', 'colors'));
    }
